            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="books.php">Knygos</a>
                        </li>
                        <li class="nav-item">
...
<?php include('../header.php'); ?>
        <header class="bg-light text-dark pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h1 class="display-1">Knygos "Pavadinimas" šalinimas</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <p>
                            <a href="salinti.html" class="btn btn-danger">Taip</a>
                            <a href="knygos.html" class="btn btn-light">Ne</a>
                        </p>
                    </div>
                </div>
            </div>
